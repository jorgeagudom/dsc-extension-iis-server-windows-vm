...
while ($i -lt 2)
  {
    ...
    $PublicSettings = '{"ModulesURL":"https://github.com/jorgeagudom/dsc-extension-iis-server-windows-vm/raw/master/MatIIS.ps1.zip", "configurationFunction": "MatIIS.ps1\\MatIIS", "Properties": {"MachineName": '+'"'+$vmNameNum+'"'+'} }'
