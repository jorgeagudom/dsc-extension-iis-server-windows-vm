...
for ($i=1; $i -le 2; $i++)
{
    ...
    $PublicSettings = '{"ModulesURL":"https://github.com/jorgeagudom/lb-dsc-extension-iis-server-windows-vm/raw/master/MatIIS2.ps1.zip", "configurationFunction": "MatIIS2.ps1\\MatIIS", "Properties": {"vmName": '+'"'+$vmNameNum+'"'+'} }'
